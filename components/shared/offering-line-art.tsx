...
export function OfferingLineArt({ kind }: { kind: OfferingLineArtKind }) {
  ...
  if (kind === "Movement") {
    return (
      <svg {...commonProps}>
        ...
        <path
          d="M160 94c18 26 27 51 27 75 0 33-14 61-27 61s-27-28-27-61c0-24 9-49 27-75Z"
          opacity="0.64"
        />
  ...
  if (kind === "Ritual") {
    return (
      <svg {...commonProps}>
        ...
        <path
          d="M231 124l8-15 8 15 15 8-15 8-8 15-8-15-15-8 15-8Z"
          opacity="0.74"
        />
  ...
  return (
    <svg {...commonProps}>
      ...
      <path
        d="M160 84c-14 28-20 52-18 72 2 19 9 32 18 32s16-13 18-32c2-20-4-44-18-72Z"
        opacity="0.52"
      />
